...
def parse_state_documents(documents: list[Any], *, hub_running: bool, timestamp: float | None = None) -> UnityHubState:
    ...
    for document in documents:
        for item in (document if isinstance(document, list) else [document]):
            ...
            version = version or _first_string(item, ("version", "unityVersion", "editorVersion"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--interval-ms", type=int, default=int(os.getenv("UNITY_HUB_RPC_INTERVAL_MS", "5000")))
